        ...
        {activeEffects.map((effect) => {
          ...
          return (
            <div
              ...
              className={`flex h-5 w-5 items-center justify-center rounded-md border text-[11px] shadow-[0_6px_14px_-10px_rgba(0,0,0,0.75)] backdrop-blur-md md:h-6 md:w-6 md:text-xs ${meta.toneClassName}`}
            >
              <span>{meta.icon}</span>
            </div>
          );
