...
export const relicEffects: Record<string, EffectDefinition> = {
  ...
  relic_fafnir_hoard: {
    ...
    type: 'stackable',
    maxStack: BOSS_RELIC_DEFENSE_IGNORE_MAX_STACK,
    image: 'FafnirScaleRelic',
    description: 'A dragon scale that ignores Circle 5 mineral defense per stack.',
    descriptionKo: '보유량에 따라 제5원 광물의 방어력을 일부 무시하는 용의 비늘입니다.',
    effectId: FAFNIR_HOARD_EFFECT_ID,
